...
let slideIndex = 1,
    ...
    function showSlides(n) {
        ...
        slides.forEach((item) => item.style.display = 'none'); //первый способо скрыть слайды
        // for (let i=0; i < slides.length; i++) {      // второй способо
        //     slides[i].style.display = 'none';
        // }
        dots.forEach((item) => item.classList.remove('dot-active'));  // убираем класс актив у любуых точек
